...
\begin{tikzpicture}
    \begin{axis}[
        ...
        yticklabels = {1.8.0.1,1.8.3,1.8.9.2,1.8.10.1,1.8.10.2-init,1.8.10.2-rc,1.8.10.2-rc-2},
        colorbar,
        ...
        \addplot table[x = x,y expr=\coordindex] {
            ...
            262.8 1.8.10.2-init 100.0
            314.8 1.8.10.2-rc 100.0
            314.0 1.8.10.2-rc-2 100.0
        };
    \end{axis}
\end{tikzpicture}
