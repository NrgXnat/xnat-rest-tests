...
import org.nrg.testing.ScriptExtension;
...
import org.nrg.xnat.pojo.resources.ScanResource;
...
public class TestAnonymizer extends BaseRestTest {
    ...
    private final AnonScript anonScript1 = new AnonScript().extension(new ScriptExtension(anonScript1File));
    private final File anonScript2File = FileIO.getDataFile("anon2.das");
    private final AnonScript anonScript2 = new AnonScript().extension(new ScriptExtension(anonScript2File));
    private final File anonScript3File = FileIO.getDataFile("projectsubjectsession.das");
    private final AnonScript anonScript3 = new AnonScript().extension(new ScriptExtension(anonScript3File));
