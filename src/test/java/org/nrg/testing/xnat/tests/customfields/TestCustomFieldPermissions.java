...
public class TestCustomFieldPermissions extends BaseXnatRestTest {
    ...
    public void testCustomFieldProjectPermissions() {
        ...
        verifyGet404(privateProjectFieldScope);
        assertEquals(fieldsMap, mainInterface().readCustomFields(protectedProjectFieldScope)); // see XNAT-7131
        ...
        verifyGetIndividual404(nonexistentScope);
        verifyGetIndividual404(privateProjectFieldScope);
        assertEquals(fieldValue, mainInterface().readCustomField(protectedProjectFieldScope, fieldKey)); // // see XNAT-7131
        ...
        verifyPut404(nonexistentScope);
        verifyPut404(privateProjectFieldScope);
        ...
        verifyDelete404(nonexistentScope);
        verifyDelete404(privateProjectFieldScope);
        verifyDelete403(protectedProjectFieldScope);
        verifyDelete403(publicProjectFieldScope);
        verifyDelete403(collaboratorProjectFieldScope);
        verifyDelete403(memberScope);
    }
    ...
    public void testCustomFieldSubjectPermissions() {
        ...
        verifyGet404(nonexistentScope);
        verifyGet404(privateSubjectScope);
        verifyGet404(protectedSubjectScope);
        ...
        verifyGetIndividual404(nonexistentScope);
        verifyGetIndividual404(privateSubjectScope);
        verifyGetIndividual404(protectedSubjectScope);
        ...
        verifyPut404(nonexistentScope);
        verifyPut404(privateSubjectScope);
        verifyPut404(protectedSubjectScope);
        ...
        verifyDelete404(nonexistentScope);
        verifyDelete404(privateSubjectScope);
        verifyDelete404(protectedSubjectScope);
        verifyDelete403(publicSubjectScope);
        verifyDelete403(customSubjectScope);
        verifyDelete403(collaboratorSubjectScope);
        verifyDelete403(sharedSubjectScope);
    }
    ...
    public void testCustomFieldExperimentPermissions() {
        ...
        verifyGet404(nonexistentScope);
        verifyGet404(privateSessionScope);
        verifyGet404(protectedSessionScope);
        verifyGet404(customHiddenSessionScope);
        ...
        verifyGetIndividual404(nonexistentScope);
        verifyGetIndividual404(privateSessionScope);
        verifyGetIndividual404(protectedSessionScope);
        verifyGetIndividual404(customHiddenSessionScope);
        ...
        verifyPut404(nonexistentScope);
        verifyPut404(privateSessionScope);
        verifyPut404(protectedSessionScope);
        verifyPut404(customHiddenSessionScope);
        ...
        verifyDelete404(nonexistentScope);
        verifyDelete404(privateSessionScope);
        verifyDelete404(protectedSessionScope);
        verifyDelete404(customHiddenSessionScope);
        verifyDelete403(publicSessionScope);
        verifyDelete403(customReadSessionScope);
        verifyDelete403(collaboratorSessionScope);
        verifyDelete403(sharedSessionScope);
    }
    ...
    public void testCustomFieldScanPermissions() {
        ...
        verifyGet404(nonexistentScope);
        verifyGet404(privateScanScope);
        verifyGet404(protectedScanScope);
        verifyGet404(customHiddenScanScope);
        ...
        verifyGetIndividual404(nonexistentScope);
        verifyGetIndividual404(privateScanScope);
        verifyGetIndividual404(protectedScanScope);
        verifyGetIndividual404(customHiddenScanScope);
        ...
        verifyPut404(nonexistentScope);
        verifyPut404(privateScanScope);
        verifyPut404(protectedScanScope);
        verifyPut404(customHiddenScanScope);
        ...
        verifyDelete404(nonexistentScope);
        verifyDelete404(privateScanScope);
        verifyDelete404(protectedScanScope);
        verifyDelete404(customHiddenScanScope);
        verifyDelete403(publicScanScope);
        verifyDelete403(customReadScanScope);
        verifyDelete403(collaboratorScanScope);
        verifyDelete403(sharedScanScope);
    }
    ...
    public void testCustomFieldAssessorPermissions() {
        ...
        verifyGet404(nonexistentScope);
        verifyGet404(privateAssessorScope);
        verifyGet404(protectedAssessorScope);
        ...
        verifyGetIndividual404(nonexistentScope);
        verifyGetIndividual404(privateAssessorScope);
        verifyGetIndividual404(protectedAssessorScope);
        verifyGetIndividual404(customHiddenAssessorScope);
        ...
        verifyPut404(nonexistentScope);
        verifyPut404(privateAssessorScope);
        verifyPut404(protectedAssessorScope);
        verifyPut404(customHiddenAssessorScope);
        verifyPut403(publicAssessorScope);
        verifyPut403(collaboratorAssessorScope);
        verifyPut403(sharedAssessorScope);

        verifyDelete404(nonexistentScope);
        verifyDelete404(privateAssessorScope);
        verifyDelete404(protectedAssessorScope);
        verifyDelete404(customHiddenAssessorScope);
        verifyDelete403(publicAssessorScope);
        verifyDelete403(collaboratorAssessorScope);
        verifyDelete403(sharedAssessorScope);
    }
    ...
    private void verifyGet404(CustomFieldScope fieldScope) {
        try {
            mainInterface().readCustomFields(fieldScope);
            fail("Should have thrown exception");
        } catch (NotFoundException ignored) {}
    }

    private void verifyGetIndividual404(CustomFieldScope fieldScope) {
        try {
            mainInterface().readCustomField(fieldScope, fieldKey);
            fail("Should have thrown exception");
        } catch (NotFoundException ignored) {}
    }

    private void verifyPut404(CustomFieldScope fieldScope) {
        try {
            mainInterface().setCustomFields(fieldScope, Collections.singletonMap("BAD", "VAL"));
            fail("Should have thrown exception");
        } catch (NotFoundException ignored) {}
    }

    private void verifyPut403(CustomFieldScope fieldScope) {
        try {
            mainInterface().setCustomFields(fieldScope, Collections.singletonMap("BAD", "VAL"));
            fail("Should have thrown exception");
    ...
    private void verifyDelete404(CustomFieldScope fieldScope) {
        try {
            mainInterface().deleteCustomField(fieldScope, fieldKey);
            fail("Should have thrown exception");
        } catch (NotFoundException ignored) {}
    }

    private void verifyDelete403(CustomFieldScope fieldScope) {
        try {
            mainInterface().deleteCustomField(fieldScope, fieldKey);
            fail("Should have thrown exception");
        } catch (ForbiddenException ignored) {}
